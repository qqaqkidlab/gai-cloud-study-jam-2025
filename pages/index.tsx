...
export default function LandingPage() {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <p style={{color:'red'}}>活動結束於<strong>2025年10月31日 23:59 [GMT+8 台北時間]</strong>;<br></br>於2025年11月1日前完成您的學習紀錄，填寫<a href="https://forms.gle/SBjNtLi41exPTxic8" target="_blank" rel="noopener noreferrer">學習進度回報表單</a>。活動結束後，主辦方將統一審核所有參加者的學習成果，並預計於 2025 年 11 月 30 日前寄發通知信，請您耐心等候</p>
            <p> 活動網址： <a href="https://rsvp.withgoogle.com/events/csj-tw-2025" target="_blank" rel="noopener noreferrer">Link</a> </p>
            <p> 學習課程範圍： <a href="https://docs.google.com/spreadsheets/d/1JDqEBkzG-O5TXkJZNmACNfax1WDnonKPo2xiwWymz90/htmlview" target="_blank" rel="noopener noreferrer">Link</a>; Total Skill Badges: 25, Total Complete Badges: 46 </p>
